import { Analysis, AnalysisAttributeBuilder, analysisBuilder, AnalysisContextBuilder, BaseAttributes, BaseContext, BaseTemplateOptions, ConvertArg, KFile, loadFile, Output, Template, TemplateGenerator } from "@koge/core";
...
export function analysis<TContext extends BaseContext = BaseContext, TAttributes extends BaseAttributes = BaseAttributes>(
...
): Analysis<TContext, TAttributes, KFile> {
  return analysisBuilder<Node, TContext, TAttributes, KFile>(
    findChildren,
    parse,
    attributesBuilder,
    contextBuilder, 
